...
hashed_passwords = stauth.Hasher(get_data(column="Password", sheet="Members", worksheet=LHT)).generate()
authenticator = stauth.Authenticate(get_data(column="Name", sheet="Members", worksheet=LHT), get_data(column="Username", sheet="Members", worksheet=LHT), hashed_passwords, "lht_cookie", "lht", cookie_expiry_days=30)
